            ...
            <Layout pageTitle="About Page">
                <div className="page projects-page">
                    ...
                    <p className="page__description">
                        Below I present some of the things I built to let you
                        know about the level of my current abilities. These
                        projects are made purely for the purpose of training.
                    </p>
